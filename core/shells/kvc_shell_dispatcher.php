...
class KvcShellDispatcher {
    ...
    private function dispatch($args) {
        ...
        KvcConfiguration::set('ExecutionContext', 'shell');
        ...
        $shell_title = KvcInflector::camelize($shell_name);
        $shell_name .= '_shell';
        $shell_class_name = KvcInflector::camelize($shell_name);
        ...
        if (!$shell_exists) {
            ...
            echo "\n";
            echo 'Please make sure a shell class exists in "app/'.$shell_path.'", or execute "./wpkvc" to see a list of available shells.';
            echo "\n";
            die();
        }
