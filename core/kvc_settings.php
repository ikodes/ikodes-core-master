...
class KvcSettings {
    ...
    function __construct() {
        ...
        $this->title = KvcInflector::titleize($this->name);
        $this->key = 'kvc_'.KvcInflector::underscore($this->name);
        $this->init_settings();
    }
    ...
    public function display_field($setting_key) {
        ...
        $html = KvcFormTagsHelper::input($setting_key, $input_options);
        echo $html;
    }
    ...
    public function __call($method_name, $arguments) {
        ...
        KvcError::fatal('Undefined method: '.get_class($this).'::'.$method_name.'.');
    }
