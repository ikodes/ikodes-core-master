...
class KvcDispatcher {
    ...
    static function dispatch($options=array()) {
        ...
        $controller_class = KvcInflector::camelize($controller_name).'Controller';
        ...
        if (!is_callable(array($controller, $action))) {
            KvcError::fatal('A method for the action "'.$action.'" doesn\'t exist in "'.$controller_class.'"');
        }
        ...
        // class UserController extends KvcPublicController {
        ...
        // $widget = KvcDispatcher::dispatch(array(
        // 			'controller' => 'users',
        // 			'action'	 => 'list'
        // ));
