...
class KvcFileIncluder {
    ...
    function __construct() {
        ...
        $this->plugin_app_paths = KvcConfiguration::get('PluginAppPaths');
    ...
    public function find_theme_or_view_file($filepath)
    {
		...
		foreach ( $possible_filepaths as $filepath ) {
			foreach(KvcConfiguration::get('Plugins') as $plugin) {
    ...
    public function require_first_app_file($filepath) {
        ...
        KvcError::fatal('The file "'.$filepath.'" couldn\'t be found in any apps.');
    }
