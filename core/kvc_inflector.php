...
class KvcInflector {
    ...
    public static function class_name_from_filename($filename) {
        return KvcInflector::camelize(str_replace('.php', '', $filename));
    }
    ...
    public static function tableize($string) {
        $string = KvcInflector::underscore($string);
        $string = KvcInflector::pluralize($string);
        return $string;
    }
    ...
    public static function pluralize_titleize($string) {
        $string = KvcInflector::pluralize(KvcInflector::titleize($string));
        return $string;
    }
